...
<main class="top">
  ...
  <section class="hero04">
    <div class="containers-full flex fS sp-reverse">
  ...
  <section class="features">
    <div class="containers">
      ...
      <div class="flex jcC gap30">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>medical/" class="more bgW">医療機器物流の詳細を見る</a>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>cosmetic/" class="more bgW">化粧品物流の詳細を見る</a>
      </div>
    </div>
  </section>
  ...
  <section class="useful-wp">
    <div class="containers">
      ...
      <div class="flex jcC gap30" data-aos="fade-up">
  ...
  <section class="info">
    <div class="containers">
      ...
      <div class="flex gap30 card" data-aos="fade-up">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>strength/" class="card__box">
          <h3 class="card__box--txt">東神倉庫が選ばれる理由</h3>
        </a>
      </div>
    </div>
  </section>
      ...
      ?>
        ...
        <a href="<?php the_permalink(); ?>" class="sec-news__box">
          <dl class="flex aiC gap30 sec-news__box--item">
            <dt class="flex aiC gap20 sp-fS"><time class="time"><?php echo get_the_date('Y.m.d'); ?></time></dt>
