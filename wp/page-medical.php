...
<main class="medical">
  ...
  <section class="anc">
    <div class="containers">
      <ul class="flex jcC gap30 inherit anc__box" data-aos="fade-up">
        <li><a href="#service">サービス概要</a></li>
        <li><a href="#features">特長</a></li>
        <li><a href="#commodity">取扱い商材例</a></li>
    ...
    <div class="containers">
      ...
      <ul class="flex jcC gap30 card">
        ...
        <li class="card__box" data-aos="fade-up" data-aos-delay="500">
          ...
          <dl class="card__box--txt">
            <dt><h3>データ連携</h3></dt>
            <dd>各基幹システムとの連携もご相談ください。東神倉庫、親会社である三井物産グローバルロジスティクスの長年に亘る通販や各種業務実績から得られた知見を活かし開発されます。</dd>
          </dl>
        </li>
      </ul>
    </div>
  ...
  <section id="commodity" class="commodity deco-r">
    <div class="containers">
  ...
  <section class="material">
    <div class="containers">
      <div class="flex aiC jcC gap30 desc">
        <figure class="desc__img" data-aos="flip-up"><img src="<?php echo assets_path() ?>img/common/img-wp.png" alt="東神倉庫の医療機器物流サービス"></figure>
        <summary class="desc__box">
          <h3 class="desc__box--sub">特長・概要が3分でわかる！</h3>
          <h2 class="desc__box--ttl">東神倉庫の医療機器物流サービス</h2>
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>catalog/" class="more">サービス資料をダウンロード</a>
        </summary>
      </div>
    </div>
  </section>
  ...
  <section id="base" class="base deco-l">
    <div class="containers">
      ...
      <div class="flex item">
        ...
        <summary class="item__box">
          ...
          <dl class="flex fS item__box--txt">
            <dt>最寄り駅</dt>
            <dd>東京モノレール「大井競馬場前駅」徒歩2分<br>京浜急行線「立会川駅」より徒歩10分</dd>
          </dl>
        </summary>
      </div>
      ...
      <div class="flex item">
        <figure class="item__img" data-aos="fade-up"><img src="<?php echo assets_path() ?>img/common/img-base03.jpg" alt="大宮支店"></figure>
        <summary class="item__box">
      ...
      <div class="flex item">
        <figure class="item__img" data-aos="fade-up"><img src="<?php echo assets_path() ?>img/common/img-base04.jpg" alt="船橋アーカイブセンター"></figure>
        <summary class="item__box">
  ...
  <section class="element">
    <div class="containers">
      <h2 class="ttl-secondary">入荷～出荷の作業プロセス</h2>
      <ul class="flex item">
        <li class="item__box" data-aos="fade-right">
          <div class="item__box--num core"><small>STEP</small>1</div>
          <div class="item__box--ttl core">入荷作業</div>
          <figure class="item__box--img"><img src="<?php echo assets_path() ?>img/common/img-element01.jpg" alt="入荷作業"></figure>
          <div class="item__box--txt">お客様から送られてくる予定データを基にHT（ハンディターミナル）や音声システムを使用し、員数確認などを効率よく行います。</div>
        </li>
        <li class="item__box" data-aos="fade-right" data-aos-delay="200">
          <div class="item__box--num core v2"><small>STEP</small>2</div>
          <div class="item__box--ttl core">HTからデータ登録</div>
          <figure class="item__box--img"><img src="<?php echo assets_path() ?>img/common/img-element02.jpg" alt="HTからデータ登録"></figure>
          <div class="item__box--txt">事務所内では、HTデータをシステムに登録してお客様への報告データを作成します。</div>
        </li>
        ...
        <li class="item__box" data-aos="fade-right" data-aos-delay="400">
          ...
          <div class="item__box--ttl core">出荷作業</div>
          <figure class="item__box--img"><img src="<?php echo assets_path() ?>img/common/img-element04.jpg" alt="出荷作業"></figure>
          <div class="item__box--txt">お客様の出荷指示データを基にHT（ハンディターミナル）や音声システムを使用し、LOT No.やシリアルNo.などの指示に対して効率よく正確に作業を行います。</div>
        </li>
        <li class="item__box" data-aos="fade-right" data-aos-delay="500">
          <div class="item__box--num core v5"><small>STEP</small>5</div>
          <div class="item__box--ttl core">配送手配</div>
          <figure class="item__box--img"><img src="<?php echo assets_path() ?>img/common/img-element05.jpg" alt="配送手配"></figure>
          <div class="item__box--txt">出荷した製品を商品適正に合わせ多種多様な資材を用いて丁寧に梱包のうえ、配送会社送り状を発行し、ピッキングした商品に貼付、出荷します。</div>
        </li>
      </ul>
    </div>
  </section>
